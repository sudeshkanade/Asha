 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */ih._jsonSchemaVersion="firestore/querySnapshot/1.0",ih._jsonSchema={type:bn("string",ih._jsonSchemaVersion),bundleSource:bn("string","QuerySnapshot"),bundleName:bn("string"),bundle:bn("string")};
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
class ah{constructor(t,e){this._firestore=t,this._commitHandler=e,this._mutations=[],this._committed=!1,this._dataReader=Cc(t)}set(t,e,n){this._verifyNotCommitted();const r=uh(t,this._firestore),s=eh(r.converter,e,n),i=Ac(this._dataReader,"WriteBatch.set",r._key,s,null!==r.converter,n);return this._mutations.push(i.toMutation(r._key,Ws.none())),this}update(t,e,n,...r){this._verifyNotCommitted();const s=uh(t,this._firestore);let i;return i="string"==typeof(e=B(e))||e instanceof gc?function(t,e,n,r,s,i){const o=t.I(1,e,n),a=[Lc(e,r,n)],u=[s];if(i.length%2!=0)throw new $e(qe.INVALID_ARGUMENT,`Function ${e}() needs to be called with an even number of arguments that alternate between field names and values.`);for(let d=0;d<i.length;d+=2)a.push(Lc(e,i[d])),u.push(i[d+1]);const c=[],h=kr.empty();for(let d=a.length-1;d>=0;--d)if(!Fc(c,a[d])){const t=a[d];let e=u[d];e=B(e);const n=o.fc(t);if(e instanceof Dc)c.push(t);else{const r=kc(e,n);null!=r&&(c.push(t),h.set(t,r))}}const l=new Kn(c);return new _c(h,l,o.fieldTransforms)}(this._dataReader,"WriteBatch.update",s._key,e,n,r):function(t,e,n,r){const s=t.I(1,e,n);xc("Data must be an object, but it was:",s,r);const i=[],o=kr.empty();Un(r,(t,r)=>{const a=Pc(e,t,n);r=B(r);const u=s.fc(a);if(r instanceof Dc)i.push(a);else{const t=kc(r,u);null!=t&&(i.push(a),o.set(a,t))}});const a=new Kn(i);return new _c(o,a,s.fieldTransforms)}(this._dataReader,"WriteBatch.update",s._key,e),this._mutations.push(i.toMutation(s._key,Ws.exists(!0))),this}delete(t){this._verifyNotCommitted();const e=uh(t,this._firestore);return this._mutations=this._mutations.concat(new ui(e._key,Ws.none())),this}commit(){return this._verifyNotCommitted(),this._committed=!0,this._mutations.length>0?this._commitHandler(this._mutations):Promise.resolve()}_verifyNotCommitted(){if(this._committed)throw new $e(qe.FAILED_PRECONDITION,"A write batch can no longer be used after commit() has been called.")}}function uh(t,e){if((t=B(t)).firestore!==e)throw new $e(qe.INVALID_ARGUMENT,"Provided document reference is from a different Firestore instance.");return t}function ch(t){t=wn(t,sc);const e=wn(t.firestore,dc),n=pc(e),r=new jc(e);return function(t){if("L"===t.limitType&&0===t.explicitOrderBy.length)throw new $e(qe.UNIMPLEMENTED,"limitToLast() queries require specifying at least one orderBy() clause")}(t._query),Wu(n,t._query).then(n=>new ih(e,r,t,n))}function hh(t,e,n){t=wn(t,ic);const r=wn(t.firestore,dc),s=eh(t.converter,e,n);return lh(r,[Ac(Cc(r),"setDoc",t._key,s,null!==t.converter,n).toMutation(t._key,Ws.none())])}function lh(t,e){return Yu(pc(t),e)}function dh(t){return pc(t=wn(t,dc)),new ah(t,e=>lh(t,e))}!function(t,e=!0){Re=se,Zt(new z("firestore",(t,{instanceIdentifier:n,options:r})=>{const s=t.getProvider("app").getImmediate(),i=new dc(new Qe(t.getProvider("auth-internal")),new Je(s,t.getProvider("app-check-internal")),function(t,e){if(!Object.prototype.hasOwnProperty.apply(t.options,["projectId"]))throw new $e(qe.INVALID_ARGUMENT,'"projectId" not provided in firebase.initializeApp.');return new ur(t.options.projectId,e)}(s,n),s);return r=a({useFetchStreams:e},r),i._setSettings(r),i},"PUBLIC").setMultipleInstances(!0)),ae(qc,$c,t),ae(qc,$c,"esm2020")}();export{Qc as A,Yc as B,z as C,ch as D,k as E,N as F,hh as G,uc as H,Bc as I,dh as J,tt as L,se as S,Zt as _,C as a,I as b,ee as c,B as d,F as e,Q as f,b as g,_ as h,T as i,m as j,q as k,te as l,v as m,oe as n,x as o,$ as p,M as q,ae as r,A as s,O as t,S as u,P as v,V as w,ie as x,fc as y,ac as z};
