 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */uh._jsonSchemaVersion="firestore/querySnapshot/1.0",uh._jsonSchema={type:bn("string",uh._jsonSchemaVersion),bundleSource:bn("string","QuerySnapshot"),bundleName:bn("string"),bundle:bn("string")};
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
class hh{constructor(t,e){this._firestore=t,this._commitHandler=e,this._mutations=[],this._committed=!1,this._dataReader=Ac(t)}set(t,e,n){this._verifyNotCommitted();const r=lh(t,this._firestore),s=sh(r.converter,e,n),i=Dc(this._dataReader,"WriteBatch.set",r._key,s,null!==r.converter,n);return this._mutations.push(i.toMutation(r._key,Ws.none())),this}update(t,e,n,...r){this._verifyNotCommitted();const s=lh(t,this._firestore);let i;return i="string"==typeof(e=B(e))||e instanceof yc?function(t,e,n,r,s,i){const o=t.I(1,e,n),a=[Mc(e,r,n)],u=[s];if(i.length%2!=0)throw new $e(qe.INVALID_ARGUMENT,`Function ${e}() needs to be called with an even number of arguments that alternate between field names and values.`);for(let d=0;d<i.length;d+=2)a.push(Mc(e,i[d])),u.push(i[d+1]);const c=[],h=kr.empty();for(let d=a.length-1;d>=0;--d)if(!Uc(c,a[d])){const t=a[d];let e=u[d];e=B(e);const n=o.fc(t);if(e instanceof Nc)c.push(t);else{const r=Rc(e,n);null!=r&&(c.push(t),h.set(t,r))}}const l=new Kn(c);return new Tc(h,l,o.fieldTransforms)}(this._dataReader,"WriteBatch.update",s._key,e,n,r):function(t,e,n,r){const s=t.I(1,e,n);Lc("Data must be an object, but it was:",s,r);const i=[],o=kr.empty();Un(r,(t,r)=>{const a=Pc(e,t,n);r=B(r);const u=s.fc(a);if(r instanceof Nc)i.push(a);else{const t=Rc(r,u);null!=t&&(i.push(a),o.set(a,t))}});const a=new Kn(i);return new Tc(o,a,s.fieldTransforms)}(this._dataReader,"WriteBatch.update",s._key,e),this._mutations.push(i.toMutation(s._key,Ws.exists(!0))),this}delete(t){this._verifyNotCommitted();const e=lh(t,this._firestore);return this._mutations=this._mutations.concat(new ui(e._key,Ws.none())),this}commit(){return this._verifyNotCommitted(),this._committed=!0,this._mutations.length>0?this._commitHandler(this._mutations):Promise.resolve()}_verifyNotCommitted(){if(this._committed)throw new $e(qe.FAILED_PRECONDITION,"A write batch can no longer be used after commit() has been called.")}}function lh(t,e){if((t=B(t)).firestore!==e)throw new $e(qe.INVALID_ARGUMENT,"Provided document reference is from a different Firestore instance.");return t}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function dh(t){t=wn(t,oc);const e=wn(t.firestore,fc);return function(t,e,n={}){const r=new ze;return t.asyncQueue.enqueueAndForget(()=>c(this,null,function*(){return function(t,e,n,r,s){const i=new zu({next:a=>{i.Nu(),e.enqueueAndForget(()=>iu(t,o));const u=a.docs.has(n);!u&&a.fromCache?s.reject(new $e(qe.UNAVAILABLE,"Failed to get document because the client is offline.")):u&&a.fromCache&&r&&"server"===r.source?s.reject(new $e(qe.UNAVAILABLE,'Failed to get document from server. (However, this document does exist in the local cache. Run again without setting source to "server" to retrieve the cached document.)')):s.resolve(a)},error:t=>s.reject(t)}),o=new lu(os(n.path),i,{includeMetadataChanges:!0,qa:!0});return su(t,o)}(yield Yu(t),t.asyncQueue,e,n,r)})),r.promise}(mc(e),t._key).then(n=>function(t,e,n){const r=n.docs.get(e._key),s=new Bc(t);return new oh(t,s,e._key,r,new ih(n.hasPendingWrites,n.fromCache),e.converter)}(e,t,n))}function fh(t){t=wn(t,ic);const e=wn(t.firestore,fc),n=mc(e),r=new Bc(e);return function(t){if("L"===t.limitType&&0===t.explicitOrderBy.length)throw new $e(qe.UNIMPLEMENTED,"limitToLast() queries require specifying at least one orderBy() clause")}(t._query),function(t,e,n={}){const r=new ze;return t.asyncQueue.enqueueAndForget(()=>c(this,null,function*(){return function(t,e,n,r,s){const i=new zu({next:n=>{i.Nu(),e.enqueueAndForget(()=>iu(t,o)),n.fromCache&&"server"===r.source?s.reject(new $e(qe.UNAVAILABLE,'Failed to get documents from server. (However, these documents may exist in the local cache. Run again without setting source to "server" to retrieve the cached documents.)')):s.resolve(n)},error:t=>s.reject(t)}),o=new lu(n,i,{includeMetadataChanges:!0,qa:!0});return su(t,o)}(yield Yu(t),t.asyncQueue,e,n,r)})),r.promise}(n,t._query).then(n=>new uh(e,r,t,n))}function ph(t,e,n){t=wn(t,oc);const r=wn(t.firestore,fc),s=sh(t.converter,e,n);return mh(r,[Dc(Ac(r),"setDoc",t._key,s,null!==t.converter,n).toMutation(t._key,Ws.none())])}function mh(t,e){return Xu(mc(t),e)}function gh(t){return mc(t=wn(t,fc)),new hh(t,e=>mh(t,e))}!function(t,e=!0){Re=se,Zt(new z("firestore",(t,{instanceIdentifier:n,options:r})=>{const s=t.getProvider("app").getImmediate(),i=new fc(new Qe(t.getProvider("auth-internal")),new Je(s,t.getProvider("app-check-internal")),function(t,e){if(!Object.prototype.hasOwnProperty.apply(t.options,["projectId"]))throw new $e(qe.INVALID_ARGUMENT,'"projectId" not provided in firebase.initializeApp.');return new ur(t.options.projectId,e)}(s,n),s);return r=a({useFetchStreams:e},r),i._setSettings(r),i},"PUBLIC").setMultipleInstances(!0)),ae($c,zc,t),ae($c,zc,"esm2020")}();export{Wc as A,Xc as B,z as C,fh as D,k as E,N as F,th as G,ph as H,cc as I,qc as J,dh as K,tt as L,gh as M,se as S,Zt as _,C as a,I as b,ee as c,B as d,F as e,Q as f,b as g,_ as h,T as i,m as j,q as k,te as l,v as m,oe as n,x as o,$ as p,M as q,ae as r,A as s,O as t,S as u,V as v,P as w,ie as x,pc as y,uc as z};
